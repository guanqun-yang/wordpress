...
- Consecutive formulas should be included only in one pair of `$`; otherwise there will be rendering errors. For example, `$a$, $b$` is wrong; we should use `$a, b$` instead.
